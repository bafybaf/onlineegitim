-- Yerel XAMPP sıfır kurulum. Docker schema.sql kullanır (DROP yok).
SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

DROP DATABASE IF EXISTS `online_ilahiyat`;
CREATE DATABASE `online_ilahiyat` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `online_ilahiyat`;
...
CREATE TABLE live_board (
  ...
  screen TINYINT NOT NULL DEFAULT 0,
  board_full TINYINT NOT NULL DEFAULT 0,
  cam_x DECIMAL(5,4) NOT NULL DEFAULT 0.7200,
  cam_y DECIMAL(5,4) NOT NULL DEFAULT 0.0400,
