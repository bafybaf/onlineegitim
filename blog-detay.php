...
if (!$p) {
    ...
    echo '<main class="mx-auto max-w-3xl px-4 py-16"><h1 class="font-display text-4xl">Yazı bulunamadı</h1><p class="mt-3"><a class="font-extrabold text-navy" href="' . e(page_url('blog')) . '">Duyurulara dön</a></p></main>';
    public_foot();
    exit;
}
...
<main class="mx-auto max-w-3xl px-4 py-14 lg:px-8">
  ...
  <h1 class="font-display mt-2 text-4xl"><?= e($p['title']) ?></h1>
  <div class="mt-6 text-lg leading-relaxed"><?= nl2br(e((string) $p['body'])) ?></div>
